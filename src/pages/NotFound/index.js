...
const NotFound = () => {
  ...
  if (!isMobile) {
    window.onmousemove = (e) => {
      ...
      if (cursorFollower && imageZone && notFoundWrapper) {
        const limitOffset = (cursorFollower.offsetWidth * (13 / 24)) / 2;
        ...
        else if (e.pageX - cursorFollower.offsetWidth * (11 / 24) > maxX) left = maxX;
        else left = xPos;
