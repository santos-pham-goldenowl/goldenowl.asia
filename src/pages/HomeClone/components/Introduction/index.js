...
const Introduction = () => (
  <section className="introduction-clone">
    <div className="row">
      <div className="col-12 col-md-6 ml-auto align-items-center">
        <h3 className="introduction-clone__title">We are Golden Owl</h3>
        <p className="introduction-clone__text">
